import { HoverButton, PrimaryButton } from "./Button";
import goToSection from "../../utils/navigate";
import { CaseStudies } from "../../constants";

const Header = () => {
  return (
    <div className="sticky top-4 md:top-6 lg:top-8 2xl:top-12 z-50 px-4 md:px-12 lg:px-16 xl:px-24 min-[90rem]:px-[7.5rem] mt-6 lg:mt-10 xl:mt-[3.25rem] w-screen flex items-center justify-center max-w-[90rem] ">
      <div className="w-full px-4 2xl:px-8 py-3 lg:py-5 2xl:py-7 flex items-center justify-between backdrop-blur-2xl bg-[#484848]/20 rounded-xl">
        {window.location.pathname === "/" ? (
          <>
            <p className="uppercase !leading-normal text-lg lg:text-xl 2xl:text-2xl">
              Temitope Famuyiwa
            </p>
              ...
              <HoverButton
                ...
                oldContent={
                  <p onClick={() => goToSection("studies")}>
                    Case Studies ({CaseStudies.length.toString().padStart(2, "0")})
                  </p>
                }
                newContent={
                  <p
